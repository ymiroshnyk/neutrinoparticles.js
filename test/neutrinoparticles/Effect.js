...
describe('Effect', function()
{
    ...
    describe('construct', function()
    {
        it('construct without error', function() {
            var effect = new NP.Effect(new this.EmptyEffectModel());
        ...
        it('init position and rotation correctly 1', function() {
            var effect = new NP.Effect(new this.EmptyEffectModel());
            this.checkPosRot(effect, this.emptyPosition, this.emptyRotation);
        });

        it('init position and rotation correctly 2', function() {
            var effect = new NP.Effect(new this.EmptyEffectModel(), null, null);
            this.checkPosRot(effect, this.emptyPosition, this.emptyRotation);
        });
        ...
        it('init position and rotation correctly 3', function() {
            ...
            this.checkPosRot(effect, this.samplePosition, this.sampleRotation);
        });

        it('add emitter correctly', function() {
            var emitter = new this.EmptyEmitter();
            var effect = new NP.Effect(new this.OneEmitterEffectModel(emitter));
            ...
            this.checkPosRot(emitter, this.emptyPosition, this.emptyRotation);
        });
    });
    ...
    describe('restart', function() {
        beforeEach(function() {
            ...
            this.effect = new NP.Effect(new this.OneEmitterEffectModel(this.emitter));
        });

        it('without parameters', function() {
            this.effect.restart();
            assert.equal(this.emitter.restartCount, 1);
            this.checkPosRot(this.emitter, this.effect.position, this.effect.rotation);
        });
        ...
        it('with parameters', function() {
            ...
            this.checkPosRot(this.emitter, this.samplePosition, this.sampleRotation);
        });
    });
    ...
    describe('update', function() {
        ...
        it("frame time update with no move passed", function() {
            ...
            assert.equal(this.emitter.updateCount, 1);
            this.checkPosRot(this.effect, effectPositionBefore, effectRotationBefore);
            this.checkPosRot(this.emitter, emitterPositionBefore, emitterRotationBefore);
        });
        ...
        it("frame time update with move", function() {
            ...
            assert.equal(this.emitter.updateCount, 1);
            this.checkPosRot(this.effect, effectPositionAfter, effectRotationAfter);
            this.checkPosRot(this.emitter, effectPositionAfter, effectRotationAfter);
        });
        ...
        it("two half frames update with move", function() {
            ...
            assert.equal(this.emitter.updateCount, 1);
            this.checkPosRotEps(this.effect, effectPositionAfter, 
                math.axisangle2quat_([0, 1, 0], effectRotationAngleAfter), 0.0001);
            this.checkPosRotEps(this.emitter, effectPositionAfter, 
                math.axisangle2quat_([0, 1, 0], effectRotationAngleAfter), 0.0001);
        });
        ...
        var scaledFrameTimeUpdateWithMove = function(scale) {
            ...
            this.checkPosRotEps(this.effect, effectPositionAfter, effectRotationAfter, 0.0001);
            this.checkPosRotEps(this.emitter, [truncScale, truncScale, truncScale], 
    ...
    describe('resetPosition', function() {
        ...
        it("with no parameters", function() {
            ...
            this.checkPosRot(this.effect, this.emptyPosition, this.emptyRotation);
            this.checkPosRot(this.emitter, this.emptyPosition, this.emptyRotation);
        });
        ...
        it("with parameters", function() {
            ...
            assert.equal(this.emitter.resetPositionCount, 1);
            this.checkPosRot(this.effect, this.samplePosition, this.sampleRotation);
            this.checkPosRot(this.emitter, this.samplePosition, this.sampleRotation);
        });
    });
    ...
    describe('getNumParticles', function() {
        beforeEach(function() {
            ...
            this.effect = new NP.Effect(new this.TwoEmittersEffectModel(this.emitter0, this.emitter1));
        });
