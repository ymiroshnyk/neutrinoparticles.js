...
describe('Emitter functional', function()
{
    beforeEach(function() {
        ...
        this.SampleEmitterModel = class SampleEmitterModel {
            ...
            initEmitter(emitter) {
                ...
                emitter.addGeneratorModel(Neutrino.GeneratorPeriodic, this.generatorModel);
                emitter.addTerminatorModel(Neutrino.TerminatorCondit, this.terminatorModel);
    ...
    describe('Emitter.initiate()', function() {
        it('With generator.rate == 1 should generate particle right after Emitter.initiate()', function() {
            ...
            let pool = new Neutrino.EmitterParticlesPool(10, function() { return {}; });
            let model = new this.SampleEmitterModel(generatorModel, terminatorModel);
            let emitter = new Neutrino.Emitter(effect, pool, model);
